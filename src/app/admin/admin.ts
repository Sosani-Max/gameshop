...
import { FormsModule } from '@angular/forms'; // ✅ เพิ่มเพื่อให้ใช้ [(ngModel)] ได้

@Component({
  selector: 'app-admin',
  standalone: true,
  imports: [RouterModule, CommonModule, FormsModule], // ✅ เพิ่ม FormsModule
